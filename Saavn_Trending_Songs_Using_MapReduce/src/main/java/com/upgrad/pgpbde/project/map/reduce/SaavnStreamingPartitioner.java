...
public class SaavnStreamingPartitioner extends Partitioner<SaavnStreamingKey, SaavnStreamingValue> implements Configurable {
	...
	/** The HashMap<Integer, Integer> stores the <b> trendingDay </b> as Key and <b> Reducer Number </b> as Value. 
	...
	/** This method returns the partition number based on the value of the <b> trendingDay </b> from the <b> HashMap<Integer, Integer> dayMap </b> */
	public int getPartition(SaavnStreamingKey key, SaavnStreamingValue value, int numReduceTasks) {
		
		return dayMap.get(value.getTrendingDay());
