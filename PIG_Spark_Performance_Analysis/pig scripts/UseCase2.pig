...
records = LOAD 's3://pgpbdepigdata/input/trip_yellow_taxi.data' USING PigStorage(',') AS (VendorID, TPEP_PickUp_DateTime, TPEP_DropOff_DateTime, Passenger_Count, Trip_Distance, RateCodeID:int, Store_And_Forward_Flag, PULocationID, DOLocationID, Payment_Type, Fare_Amount, Extra, MTA_Tax, Tip_Amount, Tolls_Amount, Improvement_Surcharge, Total_Amount);
...
-- For Running On AWS EMR With Sample Data On S3
STORE final_records INTO 's3://pgpbdepigdata/output/usecase2.output';
