...
public class StockDataAnalysis {
	...
	public static void simpleMovingAvgClosePrice(Map<String,String> configAnalysis) {
		
		/* This is the name of the analysis to be performed on streaming data*/
		final String ANALYSIS_NAME		           = configAnalysis.get("analysis.name");
				
		/* The Batch Interval Is Defined To Be 01 Minute */
		int batchInterval                          = Integer.parseInt(configAnalysis.get("analysis.batch.interval"));
		
		/* The Window Duration Is Defined To Be 10 Minutes */
		int windowDuration                         = Integer.parseInt(configAnalysis.get("analysis.window.duration"));
		
		/* The Sliding Window Duration Is Defined To Be 05 Minutes */
		int slidingWindowDuration                  = Integer.parseInt(configAnalysis.get("analysis.sliding.window.duration"));
		
		/* The first command-line value which points to the absolute path on the file system where streaming input data is stored. */ 
		inputStreamFolderLocation                  = configAnalysis.get("common.input.path");
		
		/* The second command-line value which points to absolute path on the file system where output data is used to be stored. */
		outputStreamFolderLocation                 = configAnalysis.get("common.output.path")+ANALYSIS_NAME;
		...
		try {
			...
			conf = new SparkConf().setMaster("local[*]").setAppName(ANALYSIS_NAME);
	...
	public static void stockWithMaxProfit(Map<String,String> configAnalysis) {
	...
	public static void stocksWithRSI(Map<String,String> configAnalysis) {
	...
	public static void stockWithMaximumVolume (Map<String,String> configAnalysis) {
