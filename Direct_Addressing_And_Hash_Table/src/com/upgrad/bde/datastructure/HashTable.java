package com.upgrad.bde.datastructure;
...
public class HashTable {
	...
	private static EVM[] evmHashTable;
	 ...
	 */
	private static int totalEVMBucket       = 10;
	 ...
	 */
	private static int evmHTSize            = 0;
	...
	static {
		...
		evmHashTable            = new EVM [totalEVMBucket];
	...
	public static void ADD(int voterId, short candidateId) {
        ...
        try {
	        ...
	        EVM head = evmHashTable[index];
	        
	        EVM newEVM = new EVM(voterId, candidateId);
	        
	        newEVM.setNext(head);
	        
	        evmHashTable[index] = newEVM;	 
	 ...
	 * <p>
	 * This method is implemented for the hash table data structure <b> evmHashTable </b> which is of type <b> EVM </b>.
	 */
	public static void rehashEVM() {
		
		EVM[] temp;
		
		try {

			totalEVMBucket  = 2 * totalEVMBucket;
			totalEVMBucket  = getNextPrime(totalEVMBucket);
			evmHTSize       = 0;
